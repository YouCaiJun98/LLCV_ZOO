...
__all__ = ['LSID_Denoise', 'lsid_denoise']
...
class LSID_Denoise(nn.Module):
    def __init__(self, inchannel=4, block_size=2, outchannel=None):
        super(LSID_Denoise, self).__init__()
...
def lsid_denoise(pretrained:bool=False, model_path:str=None, device=None,**kwargs):
    model = LSID_Denoise(**kwargs)
