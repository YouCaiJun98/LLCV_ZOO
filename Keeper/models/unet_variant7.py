...
class LSID(nn.Module):
    def __init__(self, model_cfg):
        ...
        '''
        self.conv5_1 = nn.Conv2d(32, 1, kernel_size=3, stride=1, padding=1, bias=True)
        self.conv5_2 = nn.Conv2d(1, 1, kernel_size=3, stride=1, padding=1, bias=True)

        self.up6 = nn.ConvTranspose2d(1, 32, 2, stride=2, bias=False)
        '''
        self.conv6_1 = nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=1, bias=True)
